...
public class CadastroProfessorFrame extends javax.swing.JFrame {
    ...
    private void salvarProfessor() {
        ...
        try {
            ProfessorService.adicionarProfessor(new Professor(nome, telefone, cpf, endereco, nascimentoFormatado, email, disciplina));
            ...
            Logger.getLogger(CadastroProfessorFrame.class.getName()).log(Level.SEVERE, null, e);
        }
    }
